...
public class JTableUtils {
    ...
    public static String formatResult(List<String> columnData, Map<String, Integer> groupedData) {
        StringBuilder result = new StringBuilder("Значения столбца:\n");
        ...
        for (Map.Entry<String, Integer> entry : groupedData.entrySet()) {
            result.append(entry.getKey()).append(": ").append(entry.getValue()).append(" раз(а)\n");
        }

        return result.toString();
    }

    public static String formatResult1(List<String> rowData, Map<String, Integer> groupedDatar) {
        StringBuilder result = new StringBuilder("Значения столбца:\n");
        ...
        result.append("\nГруппировка данных:\n");
        //группировк данных
        for (Map.Entry<String, Integer> entry : groupedDatar.entrySet()) {
            result.append(entry.getKey()).append(": ").append(entry.getValue()).append(" раз(а)\n");
        }
